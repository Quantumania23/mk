...
import { TwitterIcon, DribbbleIcon, GithubIcon, LinkedInIcon, SunIcon, MoonIcon,PinterestIcon,} from "./Icons";
  ...
  return (
    ...
    {/* <TopLeftImg className="dark:bg-dark mix-blend-color-dodge"/> */}
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav>
          <CustomLink href="/" title="Home" className="mr-1" />
          <CustomLink href="/About" title="About" className="mx-1" />
          <CustomLink href="/Projects" title="Projects" className="mx-1" />
          <CustomLink href="/Articles" title="Articles" className="mx-1" />
          <CustomLink href="/Services" title="Services" className="mx-1" />
          <CustomLink
            href="/Testimonials"
            title="Testimonials"
            className="ml-1"
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <motion.a
            href="https://twitter.com/mike peace"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.5 }}
            className="w-6 mx-3"
          ...
          <motion.a
            href="https://www.linkedin.com/in/mike-mutuku-oa23a1bb"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.5 }}
            className="w-6 mx-3"
          ...
          <motion.a
            href="https://www.dribble.com/quantumania23"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.5 }}
            className="w-6 ml-3"
          ...
          <motion.a
            href="https://www.pinterest.com/mike-peace"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.5 }}
